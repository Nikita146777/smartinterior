    ...
    <div class="container">
        <div class="history__wrapper">
            <div class="history__content">
                ...
                <p>Сегодня мы реализовали более 500 проектов разного масштаба — от частных квартир до стадионов.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="services__grid">
            <div class="service-card">
                <div class="service__icon"><img src="/smartinterior/assets/images/качество.png" alt="Качество"></div>
                <h3 class="service__title">Качество</h3>
                <p class="service__desc">Проверенные технологии и материалы</p>
            </div>
            <div class="service-card">
                <div class="service__icon"><img src="/smartinterior/assets/images/инновации.png" alt="Инновации"></div>
                <h3 class="service__title">Инновации</h3>
                <p class="service__desc">Следим за новыми технологиями</p>
            </div>
            <div class="service-card">
                <div class="service__icon"><img src="/smartinterior/assets/images/надежность.png" alt="Надежность"></div>
    ...
    <div class="container">
        <div class="approach__wrapper">
            <div class="approach__content">
                ...
                <p>Каждый проект для нас уникален. Мы начинаем с изучения потребностей клиента, затем разрабатываем индивидуальное решение.</p>
